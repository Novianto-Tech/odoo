...
"""The NTERP API module defines NTERP Environments and method decorators.
...
class Environment(Mapping):
    ...
    def envs(cls):
        raise NotImplementedError(
            "Since NTERP 15.0, Environment.envs no longer works; "
    ...
    def manage(cls):
        warnings.warn(
            "Since NTERP 15.0, Environment.manage() is useless.",
    ...
    def clear_upon_failure(self):
        ...
        """
        warnings.warn(
            "Since NTERP 15.0, use cr.savepoint() instead of env.clear_upon_failure().",
            DeprecationWarning, stacklevel=2,
        )
