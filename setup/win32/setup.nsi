...
!define MUI_FINISHPAGE_LINK_LOCATION "https://erp.novianto.tech/page/contactus"
...
Section -Post
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://erp.novianto.tech"
