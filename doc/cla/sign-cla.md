...
In order for your contribution to NTERP to be accepted, you have to sign the
NTERP Contributor License Agreement (CLA). More information about this
...
3. An NTERP R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is NTERP, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the NTERP Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `odoo.com`.  In that case someone from the NTERP team will
make the pull request on your behalf.

* Printable NTERP CCLA v1.0 https://erp.novianto.tech/files/legal/NTERP-CCLA-v1.0.pdf
* Printable NTERP ICLA v1.0 https://erp.novianto.tech/files/legal/NTERP-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for NTERP is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the NTERP project

* protect the NTERP project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the NTERP project and its users from bad actors who would contribute
...
contributor really intended to contribute to the NTERP project under specific
...
The NTERP CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, NTERP S.A. to use, modify and
...
(ICLA) of NTERP.  The agreement is executed by adding your name and
...
removed from the NTERP project.
